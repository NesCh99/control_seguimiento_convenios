...
<section class="core">
    <div class="core__title">
        ...
        <span class="core__title--small">
            Actualizar la información de la Clasificación
        </span>
    </div>
    <div class="core__content">
        ...
        <div class="content__form">
            ...
            {!! Form::model($clasificacion, ['route' => ['admin.clasificaciones.update', $clasificacion], 'method'=>'put', 'class' => 'form']) !!}
                <div class="row--normal">
                    <p>
                        {!! Form::label('Nombre', 'Nombre de la Clasificacion') !!}
                        {!! Form::text('Nombre', $clasificacion->chaNombreClasificacion, ['class'=>'input form-control']) !!}
                    </p>
                    @error('Nombre')
