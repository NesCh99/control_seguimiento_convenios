        ...
        <div class="container__swiper">
         ...
         <!--Información General -->
                    <div class="content_convenio">
                        <div class="wrapper">
                            <div class="fila">
                                <span class="fila__label">ID del Eje</span>
                                <p class="fila__text"><b>{{$eje->idEje}}</b></p>
                            </div>
                        ...
                        <div class="wrapper">
                            <div class="fila">
                                ...
                                <p class="fila__text"><b>{{$eje->tstCreacionEje}}</b></p>
                            </div>

                            <div class="fila">
                                <span class="fila__label">Fecha de ultima Modificación</span>
                                <p class="fila__text">{{$eje->tstModificacionEje}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="content_convenio">
                        <div class="content__table">
                            <table class="tabla display" id="Table__Coordinadores">
                                ...
                                <tbody>
                                    @foreach($eje->convenios as $convenio)
                                        <tr class="row">
