...
<section class="core">
    ...
    <div class="core__content">
        ...
        <div class="content__form">
            ...
            {!! Form::model($eje, ['route' => ['admin.ejes.update', $eje], 'method'=>'put', 'class' => 'form']) !!}
                <div class="row--normal">
                    <p>
                        {!! Form::label('Nombre', 'Nombre del Eje') !!}
                        {!! Form::text('Nombre', $eje->chaNombreEje, ['class'=>'input form-control']) !!}
                    </p>
                    @error('Nombre')
