	...
	<div class="core__content core__content--big">
		<div class="reporte__tipo">
			...
			<div class="tipo estadistica--click tipo--big ">
				<span class="label__matriz"><i class="fa-solid fa-chart-column"></i>  Gráficos Estadísticos Convenios Vigentes</span>
			</div>
			<div class="tipo estadistica--click tipo--big caducado--click">
				<span class="label__matriz"><i class="fa-solid fa-chart-column"></i>  Gráficos Estadísticos Convenios Vigentes Caducados</span>
			</div>
		</div>
...
<!--Gráficos  -->
<script >
	var marcoEspecifico = {{count($convenioMarco)}} +{{count($convenioEspecifico)}};
	  ...
	  type: 'bar',
	    data: {
	        ...
	        datasets: [{
	            ...
	            data: [marcoEspecifico, {{count($convenioEspecifico)}}, {{count($convenioInternacional)}}],
	            backgroundColor: [
	                'rgba(13,25,191,0.2)',
